-- Demand signals (fix/demand-signals): updated availability view + burn/cover/replenishment views
-- menu_item_availability adds servings_available in the middle of the column list,
-- so CREATE OR REPLACE cannot be used; drop and recreate.
